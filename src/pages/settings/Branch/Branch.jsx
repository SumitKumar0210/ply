...
const data = [
  { name: "Branch1", mobile: "9876543210", address: "Delhi" },
  { name: "Branch2", mobile: "9876500000", address: "Mumbai" },
  { name: "Branch3", mobile: "9988776655", address: "Chennai" },
];
...
const validationSchema = Yup.object({
  ...
  const downloadCSV = () => {
    ...
    link.href = url;
    link.setAttribute("download", "branch_data.csv");
