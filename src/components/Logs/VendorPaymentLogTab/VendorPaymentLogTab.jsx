...
import { getVendorPaymentLog } from "../../../pages/Logs/slice/logSlice";

const VendorPaymentLogTab = () => {
    ...
    const fetchData = () => {
        ...
        dispatch(getVendorPaymentLog(payload));
    };
                    ...
                    <Table>
                        <TableHead>
                            <TableRow sx={{ bgcolor: 'grey.100' }}>
                                ...
                                <TableCell sx={{ fontWeight: 600 }}>Inward ID</TableCell>
                            ...
                            {loading ? (
                                ...
                                data.map((row) => (
                                    <TableRow key={row.id} hover>
                                        ...
                                        <TableCell>
                                            <Box>
                                                <Typography variant="body2" sx={{ fontWeight: 600 }}>
                                                    {row.inward?.vendor?.name || 'N/A'}
                                                </Typography>
                                                {row.inward?.vendor?.mobile && (
                                        ...
                                        <TableCell sx={{ fontWeight: 500 }}>
                                            {row.inward?.purchase_order_id || '-'}
                                        </TableCell>
                                        <TableCell>{getPaymentModeChip(row.payment_mode)}</TableCell>
...
export default VendorPaymentLogTab;