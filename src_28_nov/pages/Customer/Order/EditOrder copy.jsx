            ...
            <CardContent>
              ...
              <Grid size={12} sx={{pt:2}}>
                <Box sx={{ display: 'flex', gap: 2 }}>
                  ...
                  {/* Upload Button */}
                  <Button variant="outlined" component="label" color="secondary" sx={{mt:0}}
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (file) {
                          ...
                          // Store preview or file in state
                          setPreview(previewURL);      // optional preview state
                          formik.setFieldValue("document", previewURL); // if using Formik
                        }
                      }}
                    />
                  </Button>
